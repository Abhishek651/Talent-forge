...
const MyResume = () => {
  ...
  return (
    <div className="min-w-full min-h-full p-4 sm:p-6 lg:p-8 flex flex-col gap-6 lg:gap-8 bg-gradient-to-br from-purple-50 to-white">
                  ...
                  >
                    <div>
                      <div className="font-bold text-slate-800">
                        {ed.specialization ? `${ed.degree} in ${ed.specialization}` : ed.degree}
                      </div>
                  ...
                  <div className="space-y-3">
                    {selfDescription.education.map((edu, i) => (
                      ...
                      >
                        <div>
                          <h5 className="font-bold text-slate-800">
                            {edu.specialization ? `${edu.degree} in ${edu.specialization}` : edu.degree}
                          </h5>
                          <div className="text-sm text-slate-600">
                            {edu.institute}
                          </div>
          ...
          <div className="flex gap-3">
            ...
            {step === 6 && (
              <Button
                onClick={submit}
                disabled={loading}
                className="px-8 bg-gradient-to-r from-purple-600 to-blue-500 hover:opacity-90 shadow-md text-white font-bold tracking-wide"
              >
