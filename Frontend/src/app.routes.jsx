...
import { AuthOtpVerifyShowcasePage } from "./components/auth-otp-verify";
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/verify-otp",
        element: <AuthOtpVerifyShowcasePage />,
      },
      {
        path: "/",
        element: (
      ...
      },
      {
        ...
        ), // Placeholder, replace with actual AllReports component when ready
      },
      {
        path: "/my-resume",
        element: (
